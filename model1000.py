...
def save_checkpoint(state, filename='checkpointB3CBAM1000.pth'):
    torch.save(state, filename)
    print(f"Checkpoint saved as '{filename}'")

def load_checkpoint(filename='checkpointB3CBAM1000.pth'):
...
if __name__ == "__main__":
    try:
        ...
        checkpoint = load_checkpoint('checkpointB3CBAM1000.pth')
        if checkpoint:
